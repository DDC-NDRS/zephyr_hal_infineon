...
#define CYBSP_CAN_FD_CLK_ENABLED 1U

#if !defined (CY_USING_HAL) && !defined (CY_USING_HAL_LITE)
#define CYBSP_CAN_FD_CLK_HW CY_SYSCLK_DIV_8_BIT
#endif /* !defined (CY_USING_HAL) && !defined (CY_USING_HAL_LITE) */

#define CYBSP_CAN_FD_CLK_NUM 4U
#define CYBSP_CAN_FD_CLK_GRP_NUM ((1U << PERI_PCLK_GR_NUM_Pos) | (0U << PERI_PCLK_INST_NUM_Pos))

#if !defined (CYBSP_CAN_FD_CLK_GRP_NUM)
#define CYBSP_CAN_FD_CLK_GRP_NUM CYBSP_CAN_FD_CLK_GRP_NUM
#endif /* !defined (CYBSP_CAN_FD_CLK_GRP_NUM) */
...
#define CYBSP_UART_LOW_SPEED_CLK_ENABLED 1U

#if !defined (CY_USING_HAL) && !defined (CY_USING_HAL_LITE)
#define CYBSP_UART_LOW_SPEED_CLK_HW CY_SYSCLK_DIV_16_5_BIT
#endif /* !defined (CY_USING_HAL) && !defined (CY_USING_HAL_LITE) */

#define CYBSP_UART_LOW_SPEED_CLK_NUM 0U
#define CYBSP_UART_LOW_SPEED_CLK_GRP_NUM ((1U << PERI_PCLK_GR_NUM_Pos) | (0U << PERI_PCLK_INST_NUM_Pos))

#if !defined (CYBSP_UART_LOW_SPEED_CLK_GRP_NUM)
#define CYBSP_UART_LOW_SPEED_CLK_GRP_NUM CYBSP_UART_LOW_SPEED_CLK_GRP_NUM
#endif /* !defined (CYBSP_UART_LOW_SPEED_CLK_GRP_NUM) */
